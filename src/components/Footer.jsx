export default function Footer() {
  return (
    <footer className="w-full flex justify-center items-center py-2 bg-gray-800 text-gray-100">
      <div className="flex items-center">
        <span className="text-s mr-2">Copyright ©seifkal</span>
        <a
          href="https://github.com/seifkal"
          target="_blank"
